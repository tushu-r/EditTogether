  ...
  <div className="mx-auto h-screen max-w-screen-xl px-4 py-12 lg:flex  ">
    <div className="mx-auto max-w-xl text-center">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4">
         ...
         className="block  rounded bg-white text-black px-12 py-3 text-sm font-medium  shadow hover:bg-slate-600 focus:outline-none focus:ring active:bg-red-500 sm:w-auto"
         > Login</LoginLink>
      </div>
